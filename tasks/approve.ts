...
task("approve", "Approve")
    ...
    .setAction(async (args) => {
        ...
        await (await token1.approve(args.spender, hre.ethers.utils.parseUnits(args.amount, process.env.TOKEN_DECIMALS))).wait()
        ...
        await (await token2.approve(args.spender, hre.ethers.utils.parseUnits(args.amount, process.env.TOKEN_DECIMALS))).wait()
